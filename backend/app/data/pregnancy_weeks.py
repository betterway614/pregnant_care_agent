...
def _build_weeks() -> list[WeekData]:
    ...
    w1 = WeekData(1,
        size="—", size_cm="—", weight="—",
        milestone="末次月经首日，预产期计算起点；卵泡发育、子宫内膜脱落，尚未受孕。",
    ...
    w2 = WeekData(2,
        size="—", size_cm="—", weight="—",
        milestone="卵巢完成排卵，卵子进入输卵管等待受精；子宫内膜持续增厚，为着床准备。",
    ...
    w3 = WeekData(3,
        ...
        milestone="精卵结合形成受精卵，持续细胞分裂形成囊胚，沿输卵管向宫腔移动；本孕周仅完成受精，尚未着床。",
    ...
    w4 = WeekData(4,
        ...
        milestone="囊胚成功着床子宫内膜；胎盘、羊膜腔开始分化；三胚层形成，未来分化全身所有器官组织。",
    ...
    w5 = WeekData(5,
        ...
        milestone="胚胎呈蝌蚪形态；神经管闭合生成脑与脊髓；原始心脏雏形成型，胎盘脐带逐步建立供血。",
    ...
    w6 = WeekData(6,
        ...
        milestone="原始心脏规律搏动，阴道B超可观测胎心；大脑泡、眼耳雏形形成，上肢肢芽长出；面部轮廓开始分化。",
    ...
    w7 = WeekData(7,
        ...
        milestone="大脑快速增殖；四肢肢芽分化手臂腿部；眼鼻口完整成型，脐带供血稳定。",
    ...
    w8 = WeekData(8,
        ...
        milestone="胚胎期末尾，距离完整胎儿期（10周）还有2周；心脏四腔成型，肢芽长出指趾芽，尾部退化，全部器官初步奠基。",
    ...
    w9 = WeekData(9,
        ...
        milestone="内脏器官全部具备基础功能；手指脚趾轮廓清晰，眼睑、耳垂成型；羊水中轻微活动母体暂无法感知。",
    ...
    w10 = WeekData(10,
        ...
        milestone="胚胎期正式结束，进入胎儿阶段；器官框架全部成型，进入功能发育期；外生殖器分化，B超无法分辨性别；指甲、牙胚萌发。",
    ...
    w11 = WeekData(11,
        ...
        milestone="胎儿自主吞咽羊水、蹬腿；指纹、肠道蠕动、肾脏产尿功能建立；面部五官轮廓清晰。",
    ...
    w12 = WeekData(12,
        ...
        milestone="手指脚趾完全分离，吮吸、打嗝反射建立；20颗乳牙牙胚完整形成；双眼向面部正中移动。",
    ...
    w13 = WeekData(13,
        ...
        milestone="完整指纹成型；肋骨四肢骨骼持续骨化；声带发育，肠道从脐带移入腹腔；全身覆盖胎毛保护皮肤。",
    ...
    w14 = WeekData(14,
        ...
        milestone="胎儿自主做出皱眉、微笑、鬼脸；肝脏分泌胆汁，脾脏造血；胎毛布满全身。",
    ...
    w15 = WeekData(15,
        ...
        milestone="建立固定睡眠-活动周期；关节成型骨骼硬化；味蕾发育可分辨羊水味道；头皮毛发定型。",
    ...
    w16 = WeekData(16,
        ...
        milestone="内耳听觉结构成熟，可感知母体血流心跳；吮吸拇指反射成型；B超可分辨外生殖器。",
    ...
    w17 = WeekData(17,
        ...
        milestone="皮下脂肪开始囤积（体温调节关键组织）；脐带增粗坚韧；可对巨大声响产生胎动回应。",
    ...
    w18 = WeekData(18,
        ...
        milestone="胎儿形成稳定作息；神经髓鞘加速包裹神经纤维；肺泡开始合成活性物质；触觉全面发育。",
    ...
    w19 = WeekData(19,
        ...
        milestone="全身覆盖胎脂隔绝羊水侵蚀；大脑分区成型，五感同步发育；皮肤薄而通透可见血管。【19周仍为CRL顶臀长测量】",
    ...
    w20 = WeekData(20,
        ...
        milestone="孕期中点；可感知明暗光线；胎粪在肠道蓄积；胎动节律稳定；【20周最后一周CRL顶臀长测量】",
    ...
    w21 = WeekData(21,
        ...
        milestone="【21周起切换：从头到脚跟全长测量】每日吞咽200-500ml羊水；骨髓替代肝脏造血；胎动协调有力。",
    ...
    w22 = WeekData(22,
        ...
        milestone="五官接近足月新生儿；睫毛眉毛完全长出；大脑神经元快速建立连接；触觉灵敏可触碰自身面部。",
    ...
    w23 = WeekData(23,
        ...
        milestone="内耳平衡器官发育完善；胰腺分泌胰岛素调节血糖；皮肤褶皱多，皮下脂肪偏少。23周为有生机儿临界值。",
    ...
    w24 = WeekData(24,
        ...
        milestone="肺部大量合成肺泡表面活性物质；完整分辨酸甜苦味；对母体声音反应最灵敏；24周早产儿存活率大幅提升。",
    ...
    w25 = WeekData(25,
        ...
        milestone="肺部血管快速增殖；嗅觉成熟感知羊水气味；抓握反射完善可抓握脐带玩耍。",
    ...
    w26 = WeekData(26,
        ...
        milestone="眼睑完全睁开；视网膜发育完成，光线照射腹部胎儿会主动转头躲避；大脑沟回快速增殖，短期记忆形成。",
    ...
    w27 = WeekData(27,
        ...
        milestone="大脑皮层高速发育；固定20-40分钟睡眠循环；胎儿从母体获取基础免疫抗体。孕中期末尾。",
    ...
    w28 = WeekData(28,
        ...
        milestone="双眼可自主开合，区分昼夜明暗；出现REM梦境睡眠；神经系统持续成熟；正式进入孕晚期。",
    ...
    w29 = WeekData(29,
        ...
        milestone="皮下脂肪快速囤积，皮肤褶皱逐步抚平；全身骨骼硬化，头骨囟门保留缝隙适配产道；胎位逐步转为头朝下。",
    ...
    w30 = WeekData(30,
        ...
        milestone="明暗分辨清晰；骨髓完全造血；肺部持续成熟；胎儿储存铁、钙矿物质储备供出生后前半年使用。",
    ...
    w31 = WeekData(31,
        ...
        milestone="五感全部成熟；大脑神经连接数十亿条；肺部可完成基础气体交换；大量母体抗体传递给胎儿建立被动免疫。",
    ...
    w32 = WeekData(32,
        ...
        milestone="骨骼完全成型，脂肪持续增厚；多数胎儿自然转为头位；指甲、头发持续生长，免疫记忆建立。",
    ...
    w33 = WeekData(33,
        ...
        milestone="大脑神经高速发育；头骨囟门保持柔软，分娩时颅骨可重叠缩小头围；皮下脂肪持续填充皮肤。",
    ...
    w34 = WeekData(34,
        ...
        milestone="肺部基本成熟，34周分娩存活率接近100%，极少长期呼吸机支持；母体抗体持续输入，皮肤粉嫩光滑。",
    ...
    w35 = WeekData(35,
        ...
        milestone="脏器发育基本完成，剩余周期仅增重、完善肺部功能；肾脏完全成熟，肝脏代谢废物；绝大多数胎儿固定头位。",
    ...
    w36 = WeekData(36,
        ...
        milestone="肺部完全成熟可自主呼吸；脸颊囤积吸吮脂肪垫，保障产后有效吮吸母乳；胎毛大量脱落，消化系统适配母乳。",
    ...
    w37 = WeekData(37,
        ...
        milestone="正式足月（37w0d-41w6d均为足月）；所有器官成熟；自主模拟呼吸运动，为第一次肺部扩张做准备。",
    ...
    w38 = WeekData(38,
        ...
        milestone="每日增重14-28g；胎脂仅残留皮肤褶皱处；胎粪完整储存在肠道等待出生排出；肺部完成最终成熟。",
    ...
    w39 = WeekData(39,
        ...
        milestone="胎儿完全发育成熟；肺部发育完善可独立换气；母体储备抗体可保护新生儿6个月抵御常见感染。",
    ...
    w40 = WeekData(40,
        ...
        milestone="足月待产；全身发育完善；头骨骨板可重叠适配产道，出生后头型临时变形，数周自然恢复。",
